...
export const RECOMMENDED_SNACKS = [
  new Meal(
    "1",
    ...
    false, // Not Pro-only
    "Snacks",
    "A hearty vegan snack with bold seasoning and roasted to perfection.",
    ["Vegan", "Healthy", "Bold Flavors"]
  ),
  new Meal(
    "2",
    ...
    false,
    "Snacks",
    "Indian-spiced chicken served with warm naan bread for a flavorful snack.",
    ["Spicy", "Savory", "Indian-Inspired"]
  ),
  new Meal(
    "3",
    "Shrimp Scampi",
    ...
    false,
    "Snacks",
    "A light and buttery shrimp dish perfect for pairing with pasta or bread.",
    ["Seafood", "Light", "Quick"]
  )
];
